      ...
      <div className='hero-main-container'>
        ...
        <div className='hero-main'>
          <h1 className='hero-name'>
            HI, I &rsquo; m <span className='yellow'>Bola Salah</span>
          </h1>
          <TextEffect />
          ...
          <div className='hero-container-cv'>
            <a
              href='./cv/FrontEnd-Bola-Resume.pdf'
              download
              onClick={notify}
              target='_blank'
              className='hero-cv-download-link'
            >
              <p>download cv</p>
            ...
            />
            <Link
              href='https://drive.google.com/file/d/15HmB6f3uzaYmkU7hocyGVrdmo-XrOr-O/view?usp=sharing'
              target='_blank'
              className='hero-cv-download-link'
            >
              <p>View cv</p>
